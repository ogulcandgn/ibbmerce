    ...
    <Card cardClass={grid ? `${styles.grid}` : `${styles.list}`}>
      <div className="w-full rounded-lg shadow-xl my-8">
        ...
        <div className="px-5 mt-2 pb-5 text-center">
          ...
          <button className="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Sepete Ekle
          </button>
        </div>
      </div>
